            ...
            <div class="modal-body p-0">
                ...
                <div class="p-3">
                    <div class="d-flex mb-3">
                        <a href="#" class="mr-3">
                            <img src="{{ asset('assets/global/images/demo/users/face1.jpg') }}" width="36" height="36"
                    ...
                    <div class="d-flex mb-3">
                        <a href="#" class="mr-3">
                            <img src="{{ asset('assets/global/images/demo/users/face3.jpg') }}" width="36" height="36"
                                class="rounded-circle" alt="">
                        </a>
                        <div class="flex-1">
                ...
                <div class="p-3">
                    <div class="d-flex mb-3">
                        <a href="#" class="mr-3">
                            <img src="{{ asset('assets/global/images/demo/users/face4.jpg') }}" width="36" height="36"
                                class="rounded-circle" alt="">
                        </a>
                        <div class="flex-1">
                    ...
                    <div class="d-flex mb-3">
                        <a href="#" class="mr-3">
                            <img src="{{ asset('assets/global/images/demo/users/face24.jpg') }}" width="36" height="36"
                                class="rounded-circle" alt="">
                        </a>
                        <div class="flex-1">
                    ...
                    <div class="d-flex mb-3">
                        <a href="#" class="mr-3">
                            <img src="{{ asset('assets/global/images/demo/users/face25.jpg') }}" width="36" height="36"
                                class="rounded-circle" alt="">
                        </a>
                        <div class="flex-1">
