    ...
    <div class="col-md-5">
      <div class="card">
        <div class="card-header">
          <h5 class="card-title">Form Vehicle</h5>
          <hr>
        </div>
        <div class="card-body">
          <form method="post" action="{{ route('update-vehicle', encrypt($data->id)) }}" enctype="multipart/form-data"> @csrf
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-9">
                <textarea name="description" class="form-control" id="" cols="30" rows="3" maxlength="100">{{ (old('description')) ? old('description') : $data->description }}</textarea>
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-9">
                <label class="custom-control custom-switch">
                  <input type="checkbox" name="active" class="custom-control-input" {{ (old('active')) ? "checked" : ( ($data->active) ? "checked" : "" ) }}>
