...
<div class="page-header">
    <div class="page-header-content header-elements-md-inline">
        ...
        <div class="header-elements d-none py-0 mb-3 mb-md-0">
            <a href="{{ route('form-driver') }}" class="btn btn-lg btn-secondary ml-3">
                                    ...
                                    <ul class="list-inline mb-0">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a href="{{ route('edit-driver', encrypt($obj->id)) }}" class="dropdown-item py-1 font-size-xs"><i class="icon-pencil7"></i>Edit entry</a>
                                                <form action="{{ route('delete-driver') }}" method="post" onsubmit="confirm_delete_data(this)">
                                                    @csrf
