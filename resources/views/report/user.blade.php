...
<div class="content pt-0">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">Report Data User </h5>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                        <form id="form-filter-data">
                            <div class="d-sm-flex">
                                ...
                                <div class="form-group-feedback form-group-feedback-left flex-grow-1 mb-3 mb-sm-0 ml-sm-2">
                                ...
                                <div class="ml-sm-2">
                                    <select name="role" class="select-fixed-singgle">
